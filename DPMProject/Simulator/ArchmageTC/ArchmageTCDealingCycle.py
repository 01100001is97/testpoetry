...
오브체라 =  오브 + 체라* 8
썬콜_리레극딜_6차반영 = 인피 + ms_10 * 8000 + 썬스 + 엘퀴 + ms_10 * 1510 + 에픽 + 메여축 + 스인미 + 크오솔 + 스오스 + 오라 + 엔버링크 + 썬바 + 리레 + 에이지 + 체라 + 주썬 + 프라 + 오브  + 라스피 + 썬브 + 체라*4 + 오브체라*4

준극딜_사이클 = 오브체라*12 + 에이지 + 라스피

썬콜_리레_1극딜 = 준극딜_사이클 * 2 + 썬콜_리레극딜_6차반영
