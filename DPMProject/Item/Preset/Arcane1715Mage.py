...
from Item.Accessory.Medal import SevenDayMonsterParker, ChaosVellumCrusher
...
from Item.Cash.BlackLabel import BlackLabelCap, BlackLabelCape, BlackLabelClothes, BlacklabelShoes, BlackLabelWeapon
...
ItemPreset_1715_int.append(MeisterRing_1715_int)
...
ItemPreset_1715_int.append(GuardianAngelRing_1715_int)
...
ItemPreset_1715_int.append(EventRing_15_int)

Seed = SeedRing()
ItemPreset_1715_int.append(Seed)

# 성배는 2추 단일스텟, 2추 이중스텟, 2추 올스텟
IntHolyCup_int = PinkHolyCup(optionslot=BonusSlot)
ItemPreset_1715_int.append(IntHolyCup_int)
...
ItemPreset_1715_int.append(Dominator_1715_int)
...
ItemPreset_1715_int.append(DayBreak_1715_int)
...
ItemPreset_1715_int.append(EnragedBelt_1715_int)
...
ItemPreset_1715_int.append(TwilightMark_1715_int)
...
ItemPreset_1715_int.append(PapulatusMark_1715_int)
...
ItemPreset_1715_int.append(estella_1715_int)

# 마이스터 이어링 17성 15퍼 에디 2줄 -> 마법사용은 제외
"""meister_1715 = MeisterEarRings(
    potentialOptionList=POTENTIAL_OPTION_MAGICIAN,
    optionslot=BonusSlot,
    upgrade_history=[accessoryScroll for _ in range(0, EarRingUpgradeChance.Meister.value)],
    starforce=STAR_LEVEL,
    additionalPotentialOptionList=APOTENTIAL_OPTION_MAGICIAN
)
"""
...
ItemPreset_1715_int.append(ArcaneShadeMageShoulder_1715)


# 크리스탈 웬투스 뱃지
VentusBadge = CristalVentusBadge()
ItemPreset_1715_int.append(VentusBadge)

# 칠요의 몬스터파커
Sevendays = SevenDayMonsterParker()
ItemPreset_1715_int.append(Sevendays)
...
ItemPreset_1715_int.append(fairy_int)
...
ItemPreset_1715_int.append(dunwitchhat_1715)
...
ItemPreset_1715_int.append(dunwitchrobe_1715)
...
ItemPreset_1715_int.append(dunwitchpants_1715)
...
ItemPreset_1715_int.append(arcanemageshoes)
...
ItemPreset_1715_int.append(arcanemagegloves)
...
ItemPreset_1715_int.append(arcanemagecape)
...
weaponPotential_spell = [Poten_boss_legend, Poten_Splpercent_unique1, Poten_Splpercent_unique2]

# 잠재능력 보보마
Poten_boss_unique = PotentialOptionSlot(option=PotentialEnum.BossDamage, grade=PotentialGrade.Unique, isadditional=False)
subweaponPoten_spell = [Poten_boss_legend, Poten_boss_unique, Poten_Splpercent_unique1]
...
emblemPoten_Spell = [poten_ignore_legend, Poten_Splpercent_unique1, Poten_Splpercent_unique2]
...
ItemPreset_1715_int.append(arcanestaff)
...
ItemPreset_1715_int.append(whitegoldbook)
...
ItemPreset_1715_int.append(mapleleafemblem_spell)

## 칭호 인스턴스 ##
kor = KingOfRootAbyss()
ItemPreset_1715_int.append(kor)
...
for symbol in ArcaneSymbolPreset:
    ItemPreset_1715_int.append(symbol)

for symbol in AuthenticSymbolPreset:
    ItemPreset_1715_int.append(symbol)

## 캐시 코디장비 인스턴스 ##
blacklabel_weapon = BlackLabelWeapon()
ItemPreset_1715_int.append(blacklabel_weapon)

blacklabel_cap = BlackLabelCap()
ItemPreset_1715_int.append(blacklabel_cap)

blacklabel_cape = BlackLabelCape()
ItemPreset_1715_int.append(blacklabel_cape)

blacklabel_shoes = BlacklabelShoes()
ItemPreset_1715_int.append(blacklabel_shoes)

blacklabel_clothes = BlackLabelClothes()
ItemPreset_1715_int.append(blacklabel_clothes)


# 총정리
TotalSpec = SpecVector()
cooldown = 0
for item in ItemPreset_1715_int:
