...
class 체인_라이트닝(OnPressSkill, DamageAttribute, DebuffAttribute, BuffAttribute, CombatOrdersAttribute, SkillDelayAttribute):
    def __init__(self, level:int):
        ...
        chainlighteningAttackDelay = Cooldown(miliseconds=780)
        ...
        SkillDelayAttribute.__init__(self=self, delay=chainlighteningAttackDelay)
    ...
    def Level(self, level:int):
        ...
        self.DamagePoint = self.SetChainlighteningDamage(level=level)
...
class 프리징_브레스(KeydownSkill, DamageAttribute, DebuffAttribute, CombatOrdersAttribute, CooldownAttribute, SkillDelayAttribute):
    def __init__(self, level:int):
        ...
        # 시전 딜레이
        freezingBreathCastingDelay = Cooldown(miliseconds=960)
        ...
        CombatOrdersAttribute.__init__(self=self)
        CooldownAttribute.__init__(self=self, cooldown=cooldown_time)
        SkillDelayAttribute(self, casting_delay=freezingBreathCastingDelay)
...
class 블리자드(OnPressSkill, DamageAttribute, CooldownAttribute, SkillDelayAttribute, CombatOrdersAttribute, DebuffAttribute):
    def __init__(self, level:int):
        ...
        blizzardCastingDelay = Cooldown(miliseconds=900)
        ...
        CooldownAttribute.__init__(self=self, cooldown=blizzardCooldown)
        SkillDelayAttribute.__init__(self=self, delay=blizzardCastingDelay)
        CombatOrdersAttribute.__init__(self=self)
        DebuffAttribute.__init__(self=self, debuff_stat=SpecVector(), debuff=blizzardCondition)
...
class 프로즌_오브(OnPressSkill, DamageAttribute, DebuffAttribute, DurationAttribute, IntervalAttribute, CooldownAttribute, SkillDelayAttribute, CombatOrdersAttribute):
    def __init__(self, level:int):
        ...
        frozenOrbCastingDelay = Cooldown(miliseconds=900)

        frozenOrbCondition = [ConditionEnum.빙결]

        frozenOrbDuration = Cooldown(seconds=4)

        frozenOrbInterval = Cooldown(miliseconds=210)
        ...
        CooldownAttribute.__init__(self=self, cooldown=frozenOrbCooldown)
        SkillDelayAttribute.__init__(self=self, delay=frozenOrbCastingDelay)
        CombatOrdersAttribute.__init__(self=self)
